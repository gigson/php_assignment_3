...
@section("content")
                ...
                <div class="col-md-5">
                    <div class="feature_static_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_title">
                                <h1><a href="single" target="_self">Alcatel's $180 Idol 3 4.7 is a </a></h1>
                            </div>
                            <!-- feature_article_title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        <div class="top_article_img">
                            <a href="single" target="_self"><img class="img-responsive" src="assets/img/tab_top1.jpg"
                                                                       alt="feature-top">
                            </a>
                        </div>
                        <!-- top_article_img -->
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Sony launce a new Android tablets for new
                                generation </a></h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Technology market see the new Android tablets </a>
                            </h2>
                        </div>
                        <!-- category_article_title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">A good news for gadget users Ds tech comming soon</a>
                            </h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Apple launches photo-centric app for iPads and Android
                                tablets</a></h2>
                        </div>
                        <!-- category_article_title -->
    ...
    <div class="category_section camera">
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="category_article_title">
                        <h2><a href="single" target="_self">Yasaki camera launches new generic hi-speed </a></h2>
                    </div>
                    <!-- category_article_title -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="category_article_title">
                        <h2><a href="single" target="_self">DSLR is the most old camera at this time </a></h2>
                    </div>
                    <!-- category_article_title -->
        ...
        <div class="category_article_wrapper">
            <div class="row">
                ...
                <div class="col-md-7">
                    <span class="tag orange"><a href="single" target="_self">Camera</a></span>

                    <div class="category_article_title">
                        <h2><a href="single" target="_self">Canon Camera launches photo centric Android</a></h2>
                    </div>
                    <!-- category_article_title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Marketing Tranportation Fast and </a></h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Theme Hippo launches Unship </a></h2>
                        </div>
                        <!-- category_article_title -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Huge Ultimate website builder </a></h2>
                        </div>
                        <!-- category_article_title -->
                ...
                <div class="col-md-6">
                    <div class="category_article_body">
                        ...
                        <div class="category_article_title">
                            <h2><a href="single" target="_self">Just another theme xdesign</a></h2>
                        </div>
                        <!-- category_article_title -->
    ...
    <div class="widget reviews m30">
        ...
        <div class="media">
            ...
            <div class="media-body"><h3 class="media-heading"><a href="single" target="_self">Samsung is the best
